 ...
 * generated in the no.nav.klage.gradle.plugin.xsd2java.xsd.navmetadata package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: no.nav.klage.gradle.plugin.xsd2java.xsd.navmetadata
     * 
     */
