...
import no.nav.klage.dokument.config.FeatureToggleConfig.Companion.KLAGE_GENERELL_TILGANG
import no.nav.klage.dokument.exceptions.FeatureNotEnabledException
...
class FeatureToggleInterceptor(private val unleash: Unleash) : AsyncHandlerInterceptor {
    ...
    override fun preHandle(
        ...
        if (!isEnabled) {
            throw FeatureNotEnabledException("Du er ikke gitt tilgang til kabal-document")
        }
        return isEnabled
    }
}
